...
public class ParosProperties {
    ...
    public ParosProperties() throws IOException {
        ...
        Logger.getLogger(ParosProperties.class.getName()).log(Level.FINE, "using config file: " + propFile.getAbsolutePath());
...
// <editor-fold defaultstate="collapsed" desc="Delegate to PropertyContainer">
    ...
    public synchronized void save() {
        try {
            ...
            Logger.getLogger(ParosProperties.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
